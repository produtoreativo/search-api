...
describe('ElasticController (e2e)', () => {
  ...
  beforeAll(async () => {
    ...
    const lista = [
      ...
      { id: '2', name: 'Coca Cola ', description: '600ml', active: true },

      { id: '3', name: 'Pepsi Cola ', description: '600ml', active: true },

      { id: '4', name: '51', description: '1600 ml', active: true },

      { id: '5', name: 'Coccacola', description: '1 litro', active: true },

      { id: '6', name: 'Coca Cola ', description: '600ml', active: false },
    ];

    const operations = lista.flatMap((doc) => [
      { index: { _index: 'products' } },
      doc,
    ]);
